...
namespace theDiary.Tools.Development.HostFileManager
{
    public class ToolstripButtonStateAction<T>
        : ClientActionGroupBase<T>, IClientControlStateAction<T, System.Windows.Forms.ToolStripButton>
    {
        #region Constructors
        ...
        public ToolstripButtonStateAction(string groupName, string actionName, ActionEventHandler executHandler, dynamic additional = null)
        ...
        public ToolstripButtonStateAction(string groupName, string actionName, ActionStateEventHandler<T> executHandler, dynamic additional = null)
        ...
        //public ToolstripButtonStateAction(string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler)
        //    : this(null, actionName, executeHandler, imageHandler, textHandler, null, null)
        //{
        //}

        //public ToolstripButtonStateAction(string groupName, string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler)
        //    : this(groupName, actionName, executeHandler, imageHandler, textHandler, null, null)
        //{
        //}

        //public ToolstripButtonStateAction(string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler, ActionStateEventHandler<T, bool> enableDisableHandler)
        //    : this(null, actionName, executeHandler, imageHandler, textHandler, null, enableDisableHandler)
        //{
        //}

        //public ToolstripButtonStateAction(string groupName, string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler, ActionStateEventHandler<T, bool> enableDisableHandler)
        //    : this(groupName, actionName, executeHandler, imageHandler, textHandler, null, enableDisableHandler)
        //{
        //}

        //public ToolstripButtonStateAction(string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler, ActionStateEventHandler<T, string> tooltipHandler)
        //    : this(null, actionName, executeHandler, imageHandler, textHandler, tooltipHandler, null)
        //{
        //}

        //public ToolstripButtonStateAction(string groupName, string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler, ActionStateEventHandler<T, string> tooltipHandler)
        //    : this(groupName, actionName, executeHandler, imageHandler, textHandler, tooltipHandler, null)
        //{
        //}

        //public ToolstripButtonStateAction(string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler, ActionStateEventHandler<T, string> tooltipHandler, ActionStateEventHandler<T, bool> enableDisableHandler)
        //    : this(actionName, executeHandler, imageHandler, textHandler, tooltipHandler, enableDisableHandler, null)
        //{
        //}

        //public ToolstripButtonStateAction(string groupName, string actionName, ActionStateEventHandler<T> executeHandler, ActionStateEventHandler<T, int> imageHandler, ActionStateEventHandler<T, string> textHandler, ActionStateEventHandler<T, string> tooltipHandler, ActionStateEventHandler<T, bool> enableDisableHandler)
        ...
        public void SetControl(object control, object state)
        {
            if ((state == null || state is T) 
        ...
        public void SetControl(System.Windows.Forms.ToolStripButton control)
        {
            ...
            //    control.ImageIndex = this.GetImageIndex(control, new ActionEventArgs<T>(this));

            //if (this.GetText != null)
            //    control.Text = this.GetText(control, new ActionEventArgs<T>(this));

            //if (this.GetToolTip != null)
            //    control.ToolTipText = this.GetToolTip(control, new ActionEventArgs<T>(this));

            //if (this.GetVisibility != null)
            //    control.Visible = this.GetVisibility(control, new ActionEventArgs<T>(this));
            if (this.Execute == null)
            {
                control.Click += (s, e) => base.Execute(s, new ActionEventArgs(this));
            }
            else
            {
                control.Click += (s, e) => this.Execute(s, new ActionEventArgs<T>(this, this.State));
            }
            this.SetFromAdditional(control);
        }
        ...
        {
            if (this.GetImageIndex != null)
                control.ImageIndex = this.GetImageIndex(control, new ActionEventArgs<T>(this, state));
            
            if (this.GetText != null)
                control.Text = this.GetText(control, new ActionEventArgs<T>(this, state));
            
            if (this.GetToolTip != null)
                control.ToolTipText = this.GetToolTip(control, new ActionEventArgs<T>(this, state));
            
            if (this.GetVisibility != null)
                control.Visible = this.GetVisibility(control, new ActionEventArgs<T>(this, state));
        }
        #endregion
    }
}
